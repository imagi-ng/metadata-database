...
def upgrade():
    alembic.op.create_table(
        "annotations",
        sqlalchemy.Column("id", metadata.type.UUID, primary_key=True),
        sqlalchemy.Column("annotator_id", metadata.type.UUID),
        sqlalchemy.Column("category_id", metadata.type.UUID),
        sqlalchemy.Column("channel_id", metadata.type.UUID)
    )
    ...
    alembic.op.create_table(
        "channels",
        sqlalchemy.Column("id", metadata.type.UUID, primary_key=True),
        sqlalchemy.Column("image_id", metadata.type.UUID)
    )
    ...
    alembic.op.create_table(
        "images",
        sqlalchemy.Column("id", metadata.type.UUID, primary_key=True),
        sqlalchemy.Column("imageable_id", metadata.type.UUID)
    )

    alembic.op.create_table(
        "plates",
        sqlalchemy.Column("id", metadata.type.UUID, primary_key=True),
        sqlalchemy.Column("experiment_id", metadata.type.UUID)
    )
    ...
    alembic.op.create_table(
        "stainable",
        sqlalchemy.Column("channel_id", metadata.type.UUID),
        sqlalchemy.Column("stain_id", metadata.type.UUID)
    )
    ...
    alembic.op.create_table(
        "wells",
        sqlalchemy.Column("id", metadata.type.UUID, primary_key=True),
        sqlalchemy.Column("plate_id", metadata.type.UUID),
